    ...
    return(       
      <div>
        ...
        <div className={styleChangerClass.join(' ')}>
            ...
            <div className="style_color_switcher_theme">
                <div className="colors_theme_each rhino">
                    <h4>Rhino</h4>
                    <div className="color_tab"></div>
                </div>
            </div>
            <div className="style_color_switcher_theme">
                <div className="colors_theme_each asphalt">
                    <h4>Asphalt</h4>
                    <div className="color_tab"></div>
                </div>
            </div>
            <div className="style_color_switcher_theme">
                <div className="colors_theme_each dslate">
                    <h4>Dark Slate</h4>
                    <div className="color_tab"></div>
                </div>
            </div>
            <div className="style_color_switcher_theme">
                <div className="colors_theme_each darkness">
                    <h4>Darkness</h4>
                    <div className="color_tab"></div>
                </div>
            </div>
            <div className="style_color_switcher_theme">
                <div className="colors_theme_each dgray">
                    <h4>Dark Gray</h4>
                    <div className="color_tab"></div>
                </div>
            </div>
